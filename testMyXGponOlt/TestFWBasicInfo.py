...
module_adc_chn_nums = 13
module_adjust_chn_nums = 6
module_dac_chn_nums = 3
module_base_talbe_nums = 2+1
module_drv_table_nums = 0+1
module_lutable_nums = 9+1
...
for lut_index in range(module_lutable_nums):
    ...
    if 'OK' == ret and lut_readback_data == lut_test_data:
        ...
        '''
        for item in range(lut_readback_data):
            print("{},".format(lut_readback_data[item]))
        for item in range(lut_test_data):
            print("{},".format(lut_test_data[item]))
        '''
