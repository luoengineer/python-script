...
for times in range(wr_and_rd_times):
    ...
    if wr_and_rd_success == 128:
        totalSuccess += 1
        f.write('Round.{}: B0 Direct High write data equal read data, OK'.format(times)+'\n\n')
        print("Round.{} B0 Direct High write data equal read data, OK".format(times))
    else:
        f.write('Round.{}: B0 Direct High write data not equal read data, FAIL'.format(times)+'\n\n')
        print('Round.{}: B0 Direct High write data not equal read data, FAIL'.format(times)+'\n\n')
...
if wr_and_rd_times == totalSuccess:
    ...
    f_report.write('B0 Direct High write and read data {} times PASS !'.format(wr_and_rd_times))
else:
    ...
    f_report.write('B0 Direct High write and read data {} times FAIL !'.format(wr_and_rd_times))
f.write('\n')
f_report.write('\n')
