...
class Driver_GN25L99(Driver):
    def __int__(self, name):
        self._driver_name = name

    # property adjust reg : 0x11, 'APC'
    def getAPCReg(self):
...
driveInstance = Driver_GN25L99()
driveInstance.driver_name = 'GN25L99'
driveInstance.driver_addr = 0xD0
driveInstance.driver_reg_map = [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, \
                                0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, \
                                0x14, 0x15, 0x16, 0x17, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, \
                                0x36, 0x37, 0x38, 0x39, 0x3A, 0x3B, 0x3C, 0x3D]

driveInstance.apc_reg = 0x11, 'APC', 1
driveInstance.apc_table = 2, "0x4B,0x02,0x51,0x00,0x5F,0xFF,0x01,0xC4,0x00,0x6C", 1000, 1
driveInstance.mcu_apc_adjust = 4

driveInstance.aer_reg = 0x0C, 'AER', 1
driveInstance.aer_table = 6, "0x4B,0x00,0x00,0xFF,0xE8,0xFF,0x00,0x00,0xFF,0xE8", 1000, 1
driveInstance.mcu_aer_adjust = 7

driveInstance.maxmod_reg = 0x14, 'Max MOD', 1
