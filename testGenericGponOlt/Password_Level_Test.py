...
time.sleep(1)
print("\n****************************************************************************")
print("Generic OLT Password level test, start time : {}".format(dateTime))
print("****************************************************************************")
f.write("\n****************************************************************************")
f.write("\nGeneric OLT Password level test, start time : {}".format(dateTime))
f.write("\n****************************************************************************")
f_report.write("\n****************************************************************************")
f_report.write("\nGeneric OLT Password level test, start time : {}".format(dateTime))
f_report.write("\n****************************************************************************")
...
if 0 == Res:
    ...
    f_report.write('read A0 direct raw data fail.' + '\n')
    f.close()
    f_report.close()
    sys.exit()
...
if 0 == Res:
    ...
    f_report.write('read A0 direct high raw data fail.' + '\n')
    print('read A0 direct high raw data fail.' + '\n')
    f.close()
    sys.exit()

#read raw A2 direct data
...
if 0 == Res:
    ...
    f_report.write('read A2 0-95 raw data fail.' + '\n')
    print('read A2 0-95 raw data fail.' + '\n')
    f.close()
    f_report.close()
    sys.exit()
	
#read raw A2 direct high data
...
if 0 == Res:
    ...
    f_report.write('read A2 128-255 raw data fail.' + '\n')
...
if wr_and_rd_success == 128:
    ...
    f_report.write('ERROR : no any password, write A0 direct data equal read data.' + '\n\n')
    ...
    f_report.write('PASS : no any password, write A0 direct data not equal read data.' + '\n\n')
...
if wr_and_rd_success == 128:
    ...
    f_report.write('ERROR : no any password, write A0 direct high data equal read data.' + '\n\n')
    ...
    f_report.write('PASS : no any password, write A0 direct high data not equal read data.' + '\n\n')
...
if wr_and_rd_success == 128:
    ...
    f_report.write('PASS : factory password, write A0 direct data equal read data.' + '\n\n')
    ...
    f_report.write('ERROR : factory password, write A0 direct data not equal read data.' + '\n\n')
...
if wr_and_rd_success == 128:
    ...
    f_report.write('PASS : factory password, write A0 direct high data equal read data.' + '\n\n')
    ...
    f_report.write('ERROR : factory password, write A0 direct high data not equal read data.' + '\n\n')
...
if 1 == has_user_password_flag:
    #########################################################
    #   test step 5 : user password write A0 0-127
    #########################################################
    print("\nwrite user passsword, write A0 direct  ...")
    f.write("\nwrite user passsword, write A0 direct ...")
    f_report.write("\nwrite user passsword, write A0 direct ...")
    ...
    f.write("\n")
    if wr_and_rd_success == 128:
        f.write('PASS : user password, write A0 direct data equal read data.' + '\n\n')
        f_report.write('PASS : user password, write A0 direct data equal read data.' + '\n\n')
        print("PASS: user password, write A0 direct data equal read data.")
    else:
        f.write('ERROR : user password, write A0 direct data not equal read data.' + '\n\n')
        f_report.write('ERROR : user password, write A0 direct data not equal read data.' + '\n\n')
        print("ERROR: user password, write A0 direct data not equal read data.")
    ...
    #########################################################
    #   test step 6 : user password write A0 128-255
    #########################################################
    ...
    f.write("\n")
    if wr_and_rd_success == 128:
        f.write('PASS : user password, write A0 direct high data equal read data.' + '\n\n')
        f_report.write('PASS : user password, write A0 direct high data equal read data.' + '\n\n')
        print("PASS: user password, write A0 direct high data equal read data.")
    else:
        f.write('ERROR : user password, write A0 direct high data not equal read data.' + '\n\n')
        f_report.write('ERROR : user password, write A0 direct high data not equal read data.' + '\n\n')
        print("ERROR: user password, write A0 direct high data not equal read data.")
    ...
    time.sleep(1)
#########################################################
#    test step 7 :  no any password write A2 0-95
#########################################################
...
if wr_and_rd_success == 96:
    ...
    f_report.write('ERROR : no any password, write A2 direct data equal read data.' + '\n\n')
    ...
    f_report.write('PASS: no any password, write A2 direct data not equal read data.' + '\n\n')
...
#########################################################
#    test step 8 :  no any password write A2 128-255
#########################################################
...
if wr_and_rd_success == 128:
    ...
    f_report.write('ERROR : no any password, write A2 direct high data equal read data.' + '\n\n')
    ...
    f_report.write('PASS : no any password, write A2 direct high data not equal read data.' + '\n\n')
    print("PASS: no any password, write A2 direct high data not equal read data.")



#########################################################
#    test step 9 :  factory password write A2 0-95
#########################################################
...
if wr_and_rd_success == 96:
    ...
    f_report.write('PASS : factory password, write A2 direct data equal read data.' + '\n\n')
    ...
    f_report.write('ERROR : factory password, write A2 direct data not equal read data.' + '\n\n')
...
#########################################################
#    test step 10 :  factory password write A2 128-255
#########################################################
...
if wr_and_rd_success == 128:
    ...
    f_report.write('PASS : factory password, write A2 direct high data equal read data.' + '\n\n')
    ...
    f_report.write('ERROR : factory password, write A2 direct high data not equal read data.' + '\n\n')
    print("ERROR: factory password, write A2 direct high data not equal read data.")


if 1 == has_user_password_flag:
    #########################################################
    #    test step 11 :  user password write A2 0-95
    #########################################################
    print("\nwrite user passsword, write A2 direct ...")
    f.write("\nwrite user passsword, wirte A2 direct ...")
    f_report.write("\nwrite user passsword, wirte A2 direct ...")
    Sfp_User_Pwd_Entry(user_password)
    ...
    if wr_and_rd_success == 96:
        # totalSuccess += 1
        f.write('PASS : user password, write A2 direct data equal read data.' + '\n\n')
        f_report.write('PASS : user password, write A2 direct data equal read data.' + '\n\n')
        print("PASS: user password, write A2 direct data equal read data.")
    else:
        f.write('ERROR : user password, write A2 direct data not equal read data.' + '\n\n')
        f_report.write('ERROR : user password, write A2 direct data not equal read data.' + '\n\n')
        print("ERROR: user password, write A2 direct data not equal read data.")
    ...
    #########################################################
    #    test step 12 :  factory password write A2 128-255
    #########################################################
    print("\nwrite user passsword, write A2 direct high ...")
    f.write("\nwrite user passsword, write A2 direct high ...")
    f_report.write("\nwrite user passsword, write A2 direct high ...")
    Sfp_User_Pwd_Entry(user_password)
    ...
    f.write('\n')
    print("\n")
    testEvb.objdll.AteIicRandomWrite(devUsbIndex, devSffChannel, SfpI2cAddr[1], 128, 128,
                                     byref(A2_Direct_High_WriteByte))
    time.sleep(1)
    ...
    if wr_and_rd_success == 128:
        # totalSuccess += 1
        f.write('PASS : user password, write A2 direct high data equal read data.' + '\n\n')
        f_report.write('PASS : user password, write A2 direct high data equal read data.' + '\n\n')
        print("PASS: user password, write A2 direct high data equal read data.")
    else:
        f.write('ERROR : user password, write A2 direct high data not equal read data.' + '\n\n')
        f_report.write('ERROR : user password, write A2 direct high data not equal read data.' + '\n\n')
        print("ERROR: user password, write A2 direct high data not equal read data.")


#########################################################
#    test step 13 :  restore all
#########################################################
#restore A0 0-127
print("POR...")
f.write("POR...")
...
if True == operator.eq(A0RawDataBuff, A0ReadDataBuff):
    ...
    f_report.write('A0 direct restore success.' + '\n')
    print("A0 direct restore success.")
else:
    f.write('A0 direct restore fail.' + '\n')
    f_report.write('A0 direct restore fail.' + '\n')
...
if True == operator.eq(A0_direct_high_RawDataBuff, A0ReadDataBuff):
    ...
    f_report.write('A0 direct high restore success.' + '\n')
    print("A0 direct high restore success.")
else:
    f.write('A0 direct high restore fail.' + '\n')
    f_report.write('A0 direct high restore fail.' + '\n')
...
if True == operator.eq(A2_Direct_RawDataBuff, A2_Direct_ReadDataBuff):
    ...
    f_report.write('A2 direct restore fail.' + '\n')
...
if True == operator.eq(A2_Direct_High_RawDataBuff, A2_Direct_High_ReadDataBuff):
    ...
    f_report.write('A2 direct high restore success.' + '\n')
    print("A2 direct high restore success.")
else:
    f.write('A2 direct high restore fail.' + '\n')
    f_report.write('A2 direct high restore fail.' + '\n')
...
dateTime = "{:4}-{:02}-{:02} {:02}:{:02}:{:02}".format(dateTime.tm_year,dateTime.tm_mon,dateTime.tm_mday,dateTime.tm_hour,dateTime.tm_min,dateTime.tm_sec)
print("\n****************************************************************************")
print("Generic OLT Password level test, end time : {}, elapsed time : {:2d} h {:2d} m {:.02f} s".format(dateTime, int(time.time()-startTick)//3600,int(time.time()-startTick)%3600//60,int(time.time()-startTick)%3600%60))
print("****************************************************************************")
f.write("\n****************************************************************************")
f.write("\nGeneric OLT Password level test, end time : {}, elapsed time : {:2d} h {:2d} m {:.02f} s".format(dateTime, int(time.time()-startTick)//3600,int(time.time()-startTick)%3600//60,int(time.time()-startTick)%3600%60))
f.write("\n****************************************************************************")
f_report.write("\n****************************************************************************")
f_report.write("\nGeneric OLT Password level test, end time : {}, elapsed time : {:2d} h {:2d} m {:.02f} s".format(dateTime, int(time.time()-startTick)//3600,int(time.time()-startTick)%3600//60,int(time.time()-startTick)%3600%60))
f_report.write("\n****************************************************************************")
