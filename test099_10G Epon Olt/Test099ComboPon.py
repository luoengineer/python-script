...
ENCRYPTION_RULE_TEST        = False
COMBO_1G_DRIVER_TEST        = True
...
if True == ENCRYPTION_RULE_TEST:
    with open('.\SFP+_099_Encryption_Rule_Test.py', 'rb') as fi:
        exec(fi.read())
#1G driver
if True == COMBO_1G_DRIVER_TEST:
    with open('.\Combo_Driver_GN25L96_Test.py', 'rb') as fi:
        exec(fi.read())