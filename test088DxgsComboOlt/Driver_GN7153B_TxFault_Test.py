...
# test configure
driver_name = 'GN7153B'
i2c_addr = 0x48 # driver I2C address
reg_addr_array = [99, 100, 101, 102] # driver txfault register
reg_name_array = ['TX_FAULT_LDBIAS_VTH', 'TX_FAULT_LDBIAS_CUR_TH', 'TXFAULT_LDMOD_CUR_TH', 'TXFAULT_LD_IPHOTO_TH']
reg_length = 1 # threshold register numbers
reg_max_th = [7,255,255,255]
reg_min_th = [0,0,0,0]
ddmi_i2c_addr = 'A2' # A2 or B2
