...
Res = 0xFF
Res = objdll.AteIicRandomRead(devUsbIndex, devSffChannel, ComboSfpI2cAddr[3], 0, 96, B2RawReadByte)
if 0 == Res:
...
for times in range(wr_and_rd_times):
    ...
    f.write('\n')
    objdll.AteIicRandomWrite(devUsbIndex, devSffChannel, ComboSfpI2cAddr[3], 0, 96, byref(B2WriteByte))
    time.sleep(1)
    ...
    objdll.AteIicRandomRead(devUsbIndex, devSffChannel, ComboSfpI2cAddr[3], 0, 96, randomReadByte)
...
Sfp_Factory_Pwd_Entry(user_password_type)
time.sleep(1)
objdll.AteIicRandomWrite(devUsbIndex, devSffChannel, ComboSfpI2cAddr[3], 0, 96, byref(B2RawReadByte))
time.sleep(1)
